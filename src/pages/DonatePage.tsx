      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">All donations are tax deductible to the extent allowed by law</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">See exactly how your donation is making a difference</p>
          </div>
        </div>
      </div>
    </div>
